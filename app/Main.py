...
st.markdown('##')
st.markdown('##')
st.write('### Documentation and Github repository link')
st.write('You can access the portfolio which describes the reasoning for building this application on this 📑 [link](https://glistening-whale-601.notion.site/Project-Report-9b8928961c1f41669ea86ce3409f438a?pvs=4).')
